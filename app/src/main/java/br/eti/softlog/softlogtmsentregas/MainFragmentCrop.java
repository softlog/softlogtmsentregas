...
public final class MainFragmentCrop extends Fragment
    ...
    public View onCreateView(
        ...
        idOcorrencia = ((MainActivityCrop) activity).getIdOcorrencia();
        idDocumento =  ((MainActivityCrop) activity).getIdDocumento();
        dataOcorrencia = ((MainActivityCrop) activity).getDataOcorrencia();
        horaOcorrencia = ((MainActivityCrop) activity).getHoraOcorrencia();
        nomeRecebedor = ((MainActivityCrop) activity).getNomeRecebedor();
        docRecebedor = ((MainActivityCrop) activity).getDocRecebedor();
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        if (result.getError() == null) {
            ...
            intent.putExtra("id_ocorrencia",idOcorrencia);
            intent.putExtra("id_documento",idDocumento);
            intent.putExtra("data_ocorrencia",dataOcorrencia);
            intent.putExtra("hora_ocorrencia",horaOcorrencia);
            intent.putExtra("nome_recebedor",nomeRecebedor);
            intent.putExtra("doc_recebedor",docRecebedor);
