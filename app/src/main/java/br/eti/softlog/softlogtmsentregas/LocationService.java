...
public class LocationService extends Service {
    ...
    private static final long UPDATE_INTERVAL = 60 * 1000 * 12;  /* 120 secs */
    ...
    public void onCreate() {    // initialize only once
        ...
        util = new Util();
        //Log.d("Aviso","Criando Serviço Localização");
    ...
    */
    ...
    public void onLocationChanged(Location location) {
        ...
        //Log.d("Aviso","Localização Atualizada");
        ...
        String cpf_motorista = myapp.getUsuario().getCpf().toString();
        Date date = new Date();

        String cDate = util.getDateTimeFormatYMD(date);
        TrackingGps trackingGps = new TrackingGps();
        trackingGps.setMotoristaCpf(cpf_motorista);
    ...
    public void onDestroy() {
        super.onDestroy();
        //Log.d("Aviso","Destruindo Serviço Localização");
        stopLocationUpdates();
    }
}